...
export type ScreenName = 'home' | 'level-editor' | 'game' | 'result' | null;
...
export const NavigationProvider = ({ children }: { children: ReactNode }) => {
  const [currentScreen, setCurrentScreen] = useState<ScreenName>('level-editor');
  ...
  useEffect(() => {
    ...
    return () => {
      eventEmitter.off('navigate', handler);
    };
  }, [navigate]);
