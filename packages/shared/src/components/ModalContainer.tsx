...
export const openModal = (child: ReactElement, effect = true, backgroundColor?: string) => {
...
export const ModalContainer = () => {
  ...
  const isHexColor = state.backgroundColor ? /^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/.test(state.backgroundColor) : false;
  ...
  return (
    <Dialog open={state.visible} as="div" className="relative z-99 focus:outline-none" onClose={() => {}}>
      <div
