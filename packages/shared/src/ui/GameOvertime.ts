...
import { getGlobalTicker } from '@puzzling-potions/core';
...
export class GameOvertime extends Container {
  ...
  private playOvertime() {
    ...
    this.labelOver.rotation = Math.sin(getGlobalTicker().lastTime * 0.01) * 0.05;
    this.labelOver.alpha = 0.7 + Math.sin(getGlobalTicker().lastTime * 0.02) * 0.3;
  }
